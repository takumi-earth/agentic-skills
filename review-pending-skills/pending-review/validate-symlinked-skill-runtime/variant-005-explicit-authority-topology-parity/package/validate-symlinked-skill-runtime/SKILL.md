...
Apply the pending `variant-005-explicit-authority-topology-parity` convergence design. Treat it as review evidence until the user separately authorizes promotion and synchronization.
