# Intent: variant-003-typed-model-schema
...
Keep this approach distinct from `variant-001-owner-move-manifest`, `variant-002-direct-owner-emission`. Do not converge implementation authority, activation effects, or failure semantics merely because common text could be shared.
